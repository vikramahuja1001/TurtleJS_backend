...
function getMainToolbarButtonNames(name) {
    return (['fast', 'slow', 'step', 'stop-turtle', 'clear', 'palette', 'hide-blocks', 'collapse-blocks', 'go-home', 'help' ,'init', 'commit'].indexOf(name) > -1);
};
...
function createHelpContent() {
    HELPCONTENT = [
        ...
        [_('Init'), _('Init a git Repo'), 'header-icons/help-button.svg'],
