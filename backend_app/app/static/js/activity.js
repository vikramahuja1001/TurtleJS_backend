...
define(function (require) {
	...
	createHelpContent();
        ...
        try {
            meSpeak.loadConfig('/static/lib/mespeak_config.json');
            meSpeak.loadVoice('/static/lib/voices/en/en.json');
        } catch (e) {
            console.log(e);
        }
        ...
        function init() {
            ...
            cartesianBitmap = _createGrid('/static/images/Cartesian.svg');

            polarBitmap = _createGrid('/static/images/polar.svg');
        ...
        function updatePasteButton() {
            ...
            img.src = 'static/header-icons/paste-button.svg';
        };
